...
public class kyaukphyudoubleroom extends JFrame implements ActionListener,ItemListener
{
	...
	{
		kyaukphyudoubleroom p=new kyaukphyudoubleroom();
		//p.adddata();
