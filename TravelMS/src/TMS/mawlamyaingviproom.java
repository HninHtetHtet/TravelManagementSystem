...
public class mawlamyaingviproom extends JFrame implements ActionListener,ItemListener
{
	...
	{
		mawlamyaingviproom p=new mawlamyaingviproom();
		//p.adddata();
