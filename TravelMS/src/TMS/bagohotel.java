...
public class bagohotel extends JFrame implements ActionListener 
{
	bagosingleroom s;
	bagodoubleroom p;
	bagofamilyroom f;
	...
	public bagohotel() {
		...
		JLabel c1 = new JLabel(new ImageIcon("hotelimage/bagoa.PNG"));
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == a1) {
			s = new bagosingleroom();
			ser += 1;
		} else if (e.getSource() == a2) {
			p = new bagodoubleroom();
			ser += 2;
		} else if (e.getSource() == a3) {
			f = new bagofamilyroom();
			ser += 4;
