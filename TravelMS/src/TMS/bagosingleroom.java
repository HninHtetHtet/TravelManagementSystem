...
public class bagosingleroom extends JFrame implements ActionListener, ItemListener {
	...
	public bagosingleroom() {
		...
		jspdisplay = new JScrollPane(txtdisplay, JScrollPane.VERTICAL_SCROLLBAR_ALWAYS,
	...
	public static void main(String[] args) {
		//bagosingleroom p = new bagosingleroom();
