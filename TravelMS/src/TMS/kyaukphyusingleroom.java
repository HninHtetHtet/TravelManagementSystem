...
public class kyaukphyusingleroom extends JFrame implements ActionListener,ItemListener
{
	...
	{
		kyaukphyusingleroom p=new kyaukphyusingleroom();
		//p.adddata();
