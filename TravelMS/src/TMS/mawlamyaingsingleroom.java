...
public class mawlamyaingsingleroom extends JFrame implements ActionListener,ItemListener
{
	...
	{
		mawlamyaingsingleroom p=new mawlamyaingsingleroom();
		//p.adddata();
