...
public class kyaukphyufamilyroom extends JFrame implements ActionListener,ItemListener
{
...
int tot=0;
	...
	{
		kyaukphyufamilyroom p=new kyaukphyufamilyroom();
	//	p.adddata();
