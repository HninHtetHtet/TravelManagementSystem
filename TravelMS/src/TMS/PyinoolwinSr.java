...
public class PyinoolwinSr extends JFrame implements ActionListener,ItemListener
{
	...
	{
		PyinoolwinSr p=new PyinoolwinSr();
		//p.adddata();
	...
	public void itemStateChanged(ItemEvent e) 
	{
		if(e.getSource()==jcb)
		{
			...
			{
			case 0:{sing=0;}break;
			case 1:{txtdisplay.setText("Ks 45,000");sing=45000;}break;
			case 2:{txtdisplay.setText("Ks 90,000");sing=90000;}break;
			case 3:{txtdisplay.setText("Ks 135,000");sing=135000;}break;
			case 4:{txtdisplay.setText("Ks 180,000");sing=180000;}break;
			case 5:{txtdisplay.setText("Ks 225,000");sing=225000;}break;
			case 6:{txtdisplay.setText("Ks 270,000");sing=270000;}break;
			}
		}
