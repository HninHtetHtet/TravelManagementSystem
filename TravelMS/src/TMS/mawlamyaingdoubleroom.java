...
public class mawlamyaingdoubleroom extends JFrame implements ActionListener,ItemListener
{
	...
	{
		mawlamyaingdoubleroom p=new mawlamyaingdoubleroom();
		//p.adddata();
