...
public class mawlamyaingfamilyroom extends JFrame implements ActionListener,ItemListener
{
	...
	{
		mawlamyaingfamilyroom p=new mawlamyaingfamilyroom();
		//.adddata();
